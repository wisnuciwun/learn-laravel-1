...
@section('content')
    <div>
        <img src="https://i.ibb.co.com/s5FRcmX/welcome.gif"
            style="position: absolute; top: 0; left: 0; z-index: -1; opacity: 0.3" class="w-100 h-100" alt="">
