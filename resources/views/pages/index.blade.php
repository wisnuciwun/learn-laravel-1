...
@section('content')
    <div>
        <img src="https://i.ibb.co.com/s5FRcmX/welcome.gif" style="position: absolute; top: 0; left: 0; z-index: -1; opacity: 0.3"
                ...
                <div style="text-align: center">
                    <div class="d-flex justify-content-center">
                        <a href="{{ route('index') }}" class="fade-in profile-container mb-2"
                            ...
                            <img src="https://i.ibb.co.com/Qnxw86P/Whats-App-Image-2023-10-17-at-6-27-58-PM.webp" class="img-profile appear" alt="">
                        </a>
                    </div>
                </div>
